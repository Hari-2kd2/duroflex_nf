...
Route::group(['middleware' => ['preventbackbutton', 'auth']], function () {
    ...
    Route::group(['prefix' => 'sub_department'], function () {
        Route::get('/', ['as' => 'sub_department.index', 'uses' => 'Employee\SubDepartmentController@index']);
        Route::get('/create', ['as' => 'sub_department.create', 'uses' => 'Employee\SubDepartmentController@create']);
        Route::post('/store', ['as' => 'sub_department.store', 'uses' => 'Employee\SubDepartmentController@store']);
        Route::get('/{sub_department}/edit', ['as' => 'sub_department.edit', 'uses' => 'Employee\SubDepartmentController@edit']);
        Route::put('/{sub_department}', ['as' => 'sub_department.update', 'uses' => 'Employee\SubDepartmentController@update']);
        Route::delete('/{sub_department}/delete', ['as' => 'sub_department.delete', 'uses' => 'Employee\SubDepartmentController@destroy']);
    });
    Route::group(['prefix' => 'costcenter'], function () {
        Route::get('/', ['as' => 'costcenter.index', 'uses' => 'Employee\CostCenterController@index']);
        Route::get('/create', ['as' => 'costcenter.create', 'uses' => 'Employee\CostCenterController@create']);
        Route::post('/store', ['as' => 'costcenter.store', 'uses' => 'Employee\CostCenterController@store']);
        Route::get('/{costcenter}/edit', ['as' => 'costcenter.edit', 'uses' => 'Employee\CostCenterController@edit']);
        Route::put('/{costcenter}', ['as' => 'costcenter.update', 'uses' => 'Employee\CostCenterController@update']);
        Route::delete('/{costcenter}/delete', ['as' => 'costcenter.delete', 'uses' => 'Employee\CostCenterController@destroy']);
    });
    ...
    Route::group(['prefix' => 'employee'], function () {
        ...
        Route::get('/subdept', ['as' => 'employee.subdept', 'uses' => 'Employee\EmployeeController@subdept']);
        Route::get('/costcenter', ['as' => 'employee.costcenter', 'uses' => 'Employee\EmployeeController@costcenter']);
    ...
    Route::get('/employeeTemplate', ['as' => 'employee.employeeTemplate', 'uses' => 'Employee\EmployeeController@employeeTemplate']);
    ...
    Route::group(['prefix' => 'termination'], function () {
        ...
        Route::get('/report', ['as' => 'termination.report', 'uses' => 'Employee\TerminationController@report']);
        Route::get('/create', ['as' => 'termination.create', 'uses' => 'Employee\TerminationController@create']);
        Route::post('/terminationimport', ['as' => 'termination.terminationimport', 'uses' => 'Employee\TerminationController@terminationimport']);
    ...
    Route::get('/terminationTemplate', ['as' => 'termination.terminationTemplate', 'uses' => 'Employee\TerminationController@terminationTemplate']);
