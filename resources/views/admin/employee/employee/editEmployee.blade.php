                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInput">@lang('employee.employee_id')<span
                                                class="validateRq">*</span></label>
                                        <input class="form-control number finger_id" id="finger_id"
                                            placeholder="@lang('employee.employee_id')" name="finger_id" type="text"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInput">@lang('employee.father_name')<span
                                                class="validateRq">*</span></label>
                                        <input class="form-control number father_name" id="father_name"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInput">@lang('department.sub_department_name')<span
                                                class="validateRq">*</span></label>
                                        <select name="sub_department_id"
                                            class="form-control sub_department_id  select2" required>
                                            <option value="">--- @lang('common.please_select') ---</option>
                                            @foreach ($subDepartmentList as $value)
                                                <option value="{{ $value->sub_department_id }}"
                                                    @if ($value->sub_department_id == $editModeData->sub_department_id) {{ 'selected' }} @endif>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInput">@lang('employee.cost_center')<span
                                                class="validateRq">*</span></label>
                                        <select name="cost_center_id" class="form-control cost_center_id">
                                            <option value="">--- @lang('common.please_select') ---</option>
                                            @foreach ($costCenterList as $value)
                                                <option value="{{ $value->cost_center_id }}"
                                                    @if ($value->cost_center_id == $editModeData->cost_center_id) {{ 'selected' }} @endif>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="gender" class="form-control gender select2">
                                            ...
                                            <option value="NoDisclosure"
                                                @if ('NoDisclosure' == $editModeData->gender) {{ 'selected' }} @endif>
                                                @lang('employee.nodisclosure')</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInput">@lang('work_shift.work_shift_name')</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="marital_status" class="form-control status required select2">
                                            ...
                                            <option value="NoDisclosure"
                                                @if ('NoDisclosure' == $editModeData->marital_status) {{ 'selected' }} @endif>
                                                @lang('employee.nodisclosure')</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control status select2">
                                            ...
                                            {{-- <option value="3"
                                                @if ('3' == $editModeData->status) {{ 'selected' }} @endif hidden>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="exampleInput">@lang('employee.daily_wages')<span
                                            class="validateRq">*</span></label>
                                    <div class="form-group">
                                        <input class="form-control number daily_wage" id="daily_wage"
                                            placeholder="@lang('employee.daily_wages')" name="daily_wage" type="number"
                                            step="any" value="{{ $editModeData->daily_wage }}">
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <label for="exampleInput">@lang('employee.basic_amt')<span
                                            class="validateRq">*</span></label>
                                    <div class="form-group">
                                        <input class="form-control number basic_amt" id="basic_amt" required
                                            placeholder="@lang('employee.basic_amt')" name="basic_amt" type="number"
                                            step="any" value="{{ $editModeData->basic_amt }}">
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <label for="exampleInput">@lang('employee.da_amt')<span
                                            class="validateRq">*</span></label>
                                    <div class="form-group">
                                        <input class="form-control number da_amt" id="da_amt" required
                                            placeholder="@lang('employee.da_amt')" name="da_amt" type="number"
                                            step="any" value="{{ $editModeData->da_amt }}">
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <label for="exampleInput">@lang('employee.hra_amt')<span
                                            class="validateRq">*</span></label>
                                    <div class="form-group">
                                        <input class="form-control number hra_amt" id="hra_amt" required
                                            placeholder="@lang('employee.hra_amt')" name="hra_amt" type="number"
                                            step="any" value="{{ $editModeData->hra_amt }}">
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <label for="exampleInput">@lang('employee.leave_balance')<span
                                            class="validateRq">*</span></label>
                                    <div class="form-group">
                                        <input class="form-control number leave_balance" id="leave_balance"
                                            placeholder="@lang('employee.leave_balance')" name="leave_balance" type="number"
                                            step="any" value="{{ $editModeData->leave_balance }}" readonly>
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInput">@lang('employee.service_charge')<span class="validateRq">*</span></label>
                                        <select name="service_charge" class="form-control service_charge select2">
                                            <option value="0"
                                                @if ('0' == $editModeData->service_charge) {{ 'selected' }} @endif>
                                                @lang('common.disabled')</option>
                                            <option value="1"
                                                @if ('1' == $editModeData->service_charge) {{ 'selected' }} @endif>
                                                @lang('common.enabled')</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <h3 class="box-title">@lang('employee.bank_information')</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.bank_name')<span
                                                class="validateRq">*</span></label>

                                        <input class="form-control required bank_name" id="bank_name"
                                            placeholder="@lang('employee.bank_name')" name="bank_name" type="text"
                                            value="{{ $editModeData->bank_name }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.bank_branch')<span
                                                class="validateRq">*</span></label>

                                        <input class="form-control required bank_branch" id="bank_branch"
                                            placeholder="@lang('employee.bank_branch')" name="bank_branch" type="text"
                                            value="{{ $editModeData->bank_branch }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.bank_account_no')<span
                                                class="validateRq">*</span></label>

                                        <input class="form-control number bank_account_no" id="bank_account_no"
                                            placeholder="@lang('employee.bank_account_no')" name="bank_account_no" type="text"
                                            value="{{ $editModeData->bank_account_no }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.bank_of_the_city')<span
                                                class="validateRq">*</span></label>

                                        <input class="form-control bank_of_the_city" id="bank_of_the_city"
                                            placeholder="@lang('employee.bank_of_the_city')" name="bank_of_the_city" type="text"
                                            value="{{ $editModeData->bank_of_the_city }}">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.ifsc_no')<span
                                                class="validateRq">*</span></label>

                                        <input class="form-control required ifsc_no" required id="ifsc_no"
                                            placeholder="@lang('employee.ifsc_no')" name="ifsc_no" type="text"
                                            value="{{ $editModeData->ifsc_no }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.pan_no')<span
                                                class="validateRq">*</span></label>

                                        <input class="form-control required pan_no" required id="pan_no"
                                            placeholder="@lang('employee.pan_no')" name="pan_no" type="text"
                                            value="{{ $editModeData->pan_no }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.esic_number')<span
                                                class="validateRq">*</span></label>

                                        <input class="form-control esi_card_number" id="esi_card_number"
                                            placeholder="@lang('employee.esic_number')" name="esi_card_number" type="text"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.pf_account_number')<span
                                                class="validateRq">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.aadhar_no')<span
                                                class="validateRq">*</span></label>

                                        <input class="form-control required aadhar_no" required id="aadhar_no"
                                            placeholder="@lang('employee.aadhar_no')" name="aadhar_no" type="text"
                                            value="{{ $editModeData->aadhar_no }}">
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '.department_id', function() {
            ...
            $.ajax({
                ...
                url: "{{ route('employee.subdept') }}",

                data: {
                    department_id: department_id,
                },
                success: function(response) {
                    $('.sub_department_id').html(response);
                }
            });
