                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control required father_name" required id="father_name"
                                        ...
                                        <select name="sub_department_id"
                                            ...
                                            @foreach ($subDepartmentList as $value)
                                                <option value="{{ $value->sub_department_id }}"
                                                    @if ($value->sub_department_id == old('sub_department_id')) {{ 'selected' }} @endif>
                                        ...
                                        <select name="cost_center_id" class="form-control cost_center_id">
                                            ...
                                            @foreach ($costCenterList as $value)
                                                <option value="{{ $value->cost_center_id }}"
                                                    @if ($value->cost_center_id == old('cost_center_id')) {{ 'selected' }} @endif>
                            ...
                            <h3 class="box-title">Salary Information</h3> <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control number daily_wage" id="daily_wage" required
                                            placeholder="@lang('employee.daily_wages')" name="daily_wage" type="number"
                                            step="any" value="{{ old('daily_wage') }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control number leave_balance" id="leave_balance" required
                                            placeholder="@lang('employee.leave_balance')" name="leave_balance" type="number"
                                            step="any" value="{{ old('leave_balance') }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.service_charge')<span
                                                class="validateRq">*</span></label>

                                        <select name="service_charge" class="form-control service_charge select2" required>

                                            <option value="1"
                                                @if ('1' == old('service_charge')) {{ 'selected' }} @endif>
                                                @lang('common.enabled')</option>

                                            <option value="0"
                                                @if ('0' == old('service_charge')) {{ 'selected' }} @endif>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control required bank_name" required id="bank_name"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control bank_branch" id="bank_branch"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control number bank_account_no" required id="bank_account_no"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control bank_of_the_city" required id="bank_of_the_city"
                                        placeholder="@lang('employee.bank_of_the_city')" name="bank_of_the_city" type="text"
                                        value="{{ old('bank_of_the_city') }}">
