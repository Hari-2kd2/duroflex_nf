<div class="table-responsive">
    ...
    <table id="myTable" class="table table-bordered table-hover manage-u-table">
                ...
                <tr class="{!! $value->employee_id !!}">
                    ...
                    <td>
                        ...
                        @if ($value->photo != '' && file_exists('uploads/employeePhoto/' . $value->photo))
                            <a href="{!! route('employee.show', $value->employee_id) !!}"><img style=" width: 64px; " src="{!! asset('uploads/employeePhoto/' . $value->photo) !!}"
                                    alt="user-img" class="img-circle"></a>
                        @else
                            <a href="{!! route('employee.show', $value->employee_id) !!}"> <img style=" width: 64px; " src="{!! asset('admin_assets/img/default.png') !!}"
                                    alt="user-img" class="img-circle"></a>
                        @endif
                    ...
                    <td>
                        ...
                        <br /><span class="text-muted">Sub. Unit:

                            @if (isset($value->subdepartment->sub_department_name))
                                {!! $value->subdepartment->sub_department_name !!}
                            @endif

                        </span>

                        <br /><span class="text-muted">Costcenter:

                            @if (isset($value->costcenter->cost_center_number))
                                {!! $value->costcenter->cost_center_number !!}
                            @endif
                    ...
                    <td>
                        ...
                        <br /><span class="text-muted">
                            ...
                            @if ($value->official_email != '')
                                @lang('employee.official_email'):{!! $value->official_email !!}
                            @endif
