                ...
                <div class="col-md-4">
                    <div class="white-box" style="background: #27333e">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <a href="javascript:void(0)" id="to-recover" class="text-white pull-right"><i
                                        class="fa fa-lock m-r-5"></i> Forgot password ?</a>
                            </div>
                        </div>
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-instagram btn-block text-uppercase waves-effect waves-light"
                                    type="submit">Log In</button>
                            </div>
                        </div>
                        {!! Form::close() !!}

                        <form class="form-horizontal" id="recoverform" action="{{ url('password/validatePassword') }}">
                            <div class="form-group ">
                                <div class="col-xs-12">
                            ...
                            <div class="form-group ">
                                <div class="col-xs-12">
                                    <input class="form-control input" type="text" required placeholder="Email"
                                        name="email">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
                                    <a href="javascript:void(0)" id="backToLogin" class="text-white pull-right"><i
                            ...
                            <div class="form-group text-center">
                                <div class="col-xs-12">
                                    <button
                                        class="btn btn-instagram btn-md btn-block text-uppercase waves-effect waves-light"
