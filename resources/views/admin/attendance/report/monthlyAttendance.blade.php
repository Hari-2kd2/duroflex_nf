                                ...
                                <tbody>
                                    @if (count($results) > 0)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif ($value['action'] == 'Leave')
                                                        <span class='label label-info'> {{ __('common.leave') }}
                                                        </span></p>
                                                        <?php $totalLeave += 1; ?>
                                                    @elseif ($value['action'] == 'Holiday')
                                                        <span class='label label-success'>{{ 'Holiday' }}</span>
                                                        </p>
                                                        <?php $totalHoliday += 1; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="background: #fff"><b>{{ $totalPresent }}</b>
                                                @lang('common.days')
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="background: #eee"><b>{{ $totalHoliday }}</b>
                                                @lang('common.days')
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="background: #fff"><b>{{ $totalLeave }}</b>
                                                @lang('common.days')
                                            </td>
                                        </tr>
                                        <tr>
