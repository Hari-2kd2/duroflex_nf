...
@section('content')
@section('title')
    @lang('payroll_setup.canteen_deduction_configuration')
@endsection
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-info">
                <div class="panel-heading"><i class="mdi mdi-table fa-fw"></i> @lang('payroll_setup.canteen_deduction_configuration') </div>
