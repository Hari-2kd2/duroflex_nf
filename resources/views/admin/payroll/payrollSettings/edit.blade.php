                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control bonus" id="bonus" placeholder="@lang('payroll.bonus')"
                                            name="bonus" type="number" step="any"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control el_day_limit" id="el_day_limit"
                                            placeholder="@lang('payroll.el_day_limit')" name="el_day_limit" type="number"
                                            step="any" value="{{ $editModeData->el_day_limit }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control ot_per_hour" id="ot_per_hour"
                                            placeholder="@lang('payroll.updated_at')" name="ot_per_hour" type="number"
                                            step="any" value="{{ $editModeData->ot_per_hour }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control hra" id="attendance_bonus"
                                            placeholder="@lang('payroll.attendance_bonus')" name="attendance_bonus" type="number"
                                            step="any" value="{{ $editModeData->attendance_bonus }}">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control service_charge" id="service_charge"
                                            placeholder="@lang('payroll.service_charge')" name="service_charge" type="number"
                                            step="any" value="{{ $editModeData->service_charge }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control other_allowance" id="other_allowance"
                                            placeholder="@lang('payroll.other_allowance')" name="other_allowance" type="number"
                                            step="any" value="{{ $editModeData->other_allowance }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control employee_esic" id="employee_esic"
                                            placeholder="@lang('payroll.employee_esic')" name="employee_esic" type="number"
                                            step="any" value="{{ $editModeData->employee_esic }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control employee_pf" id="employee_pf"
                                            placeholder="@lang('payroll.employee_pf')" name="employee_pf" type="number"
                                            step="any" value="{{ $editModeData->employee_pf }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control employer_esic" id="employer_esic"
                                            placeholder="@lang('payroll.employee_esic')" name="employer_esic" type="number"
                                            step="any" value="{{ $editModeData->employer_esic }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control employer_pf" id="employer_pf"
                                            placeholder="@lang('payroll.employer_pf')" name="employer_pf" type="number"
                                            step="any" value="{{ $editModeData->employer_pf }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control lwf" id="lwf"
                                            placeholder="@lang('payroll.lwf')" name="lwf" type="number"
                                            step="any" value="{{ $editModeData->lwf }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control other_deduction" id="other_deduction"
                                            step="any" placeholder="@lang('payroll.other_deduction')" name="other_deduction"
                                            type="number" value="{{ $editModeData->other_deduction }}">
                                    </div>
                                </div>
