        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <a href="{{ route('allowance.create') }}"
                class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i
                    class="fa fa-plus-circle" aria-hidden="true"></i> @lang('allowance.add_allowance')</a>
        </div>
    </div>
                            ...
                            <table id="myTable" class="table table-bordered">
                                <thead>
                                    <tr class="tr_header">
                                        ...
                                        <th>@lang('allowance.allowance_criteria')</th>
                                    ...
                                    @foreach ($results as $value)
                                        <tr class="{!! $value->allowance_id !!}">
                                            ...
                                            <td style="width: 100px;">
                                                <a href="{!! route('allowance.edit', $value->allowance_id) !!}"
                                                    class="btn btn-success btn-xs btnColor">
                                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                </a>
                                                <a href="{!! route('allowance.delete', $value->allowance_id) !!}" data-token="{!! csrf_token() !!}"
                                                    data-id="{!! $value->allowance_id !!}"
