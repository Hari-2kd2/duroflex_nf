                            ...
                            <div class="col-md-full">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1" class="text-center">
                                            <b>{{ \App\Model\Employee::where('employee_id', $salaryDetails->employee_id)->select('finger_id')->first()->finger_id }}</b>
                                        </td>
                                        <td colspan="1" class="">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class=" col-md-3 text-center">
                                                {{ ($salaryDetails->basic_salary * 0.75) / 100 }}</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="1" class=" col-md-3 "></td>
                                            <td class="col-md-3 text-center">
                                                {{ ($salaryDetails->basic_salary * 3.25) / 100 }}
                                            </td>
                                        </tr>
                                        {{-- @php
                                        dd($salaryDetailsToAllowance);
                                        @endphp --}}
                                        ...
                                        @if (count($salaryDetailsToDeduction) > 0)
                                            @foreach ($salaryDetailsToDeduction as $deduction)
                                                <tr>
                                                    <td></td>
                                                    <td></td>
                                                    <td colspan="2">{{ $deduction->deduction_name }} : </td>
                                                    <td class="text-center">
