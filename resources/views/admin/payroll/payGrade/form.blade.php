                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <input type="text" id="date" class="date" value="{{ date('t') }}"
                                    hidden>
...
<script>
    jQuery(function() {
        ...
        $(document).on("change", ".gross_salary,.percentage_of_basic  ", function() {
            ...
            // var overtime_rate = $('.overtime_rate').val(Math.round((basicSalary / date) / 4));
            // $('.overtime_rate').val(overtime_rate.toFixed(2));
