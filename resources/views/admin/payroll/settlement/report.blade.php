...
@section('content')
@section('title')
    @lang('payroll.settlement_report')
@endsection
<style>
    .employeeName {
        position: relative;
                    ...
                    <div class="panel-body">
                        ...
                        @if (isset($_GET['employee_id']))
                            <div class="row" style="margin-right: 0px;">
                                <a href="{{ route('settlementReport.download', ['employee_id' => $_GET['employee_id'], 'branch_id' => $_GET['branch_id'], 'department_id' => $_GET['department_id'], 'date' => $_GET['date']]) }}"
                            ...
                            <div class="table-responsive">
                                <table id="settlement" class="table table-bordered" style="font-size: 12px">
...
<script type="text/javascript">
    $(function() {
        ...
        $('#settlement').DataTable({
            ...
            ajax: {
                url: "{{ route('settlementReport.reportdetails') }}",
                data: function(d) {
