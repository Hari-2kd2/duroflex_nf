...
class EmployeeRepository
{
    ...
    public function makeEmployeeAccountDataFormat($data, $action = false)
    {
        ...
        $employeeAccountData['email'] = isset($data['email']) ? $data['email'] : null;
    ...
    public function makeEmployeePersonalInformationDataFormat($data)
    {
        ...
        $employeeData['sub_department_id'] = $data['sub_department_id'];

        $employeeData['cost_center_id'] = $data['cost_center_id'];
        ...
        $employeeData['bank_branch'] = $data['bank_branch'];

        $employeeData['bank_account_no'] = $data['bank_account_no'];

        $employeeData['bank_of_the_city'] = $data['bank_of_the_city'];

        $employeeData['ifsc_no'] = $data['ifsc_no'];

        $employeeData['pan_no'] = $data['pan_no'];

        $employeeData['official_email'] = $data['official_email'];

        $employeeData['father_name'] = $data['father_name'];

        $employeeData['aadhar_no'] = $data['aadhar_no'];

        $employeeData['leave_balance'] = $data['leave_balance'];

        $employeeData['basic_amt'] = $data['basic_amt'];

        $employeeData['da_amt'] = $data['da_amt'];

        $employeeData['hra_amt'] = $data['hra_amt'];

        $employeeData['daily_wage'] = $data['daily_wage'];

        $employeeData['service_charge'] = $data['service_charge'];
